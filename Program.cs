...
{
    /// <summary>
    /// Assessment 1 - C# Software Development 
    /// </summary>
    class Program
    {
        /// <summary>
        /// Asks user for login details and outputs concatenationated variant
        /// </summary>
        ...
        static void User_Name(string logonID)
        {
            ...
            do
                ...
                { }
            while (fullName == " " || String.IsNullOrWhiteSpace(fullName) || fullName.Contains(" ") == false); //loops if string doesn't contain a space or is null/empty space
        ...
        static void factorial_Result(string logonID)
        {
            ...
            do
            {
                try
                {
                    ...
                    {
                        Console.WriteLine("Factorial of 1 = 1"); //Design Doc stated wrong, corrected
